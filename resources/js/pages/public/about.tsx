                ...
                <div className="mt-12 rounded-xl border bg-white p-6 shadow-sm">
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                        ...
                        <div className="h-64 overflow-hidden rounded-lg bg-slate-100 md:h-full">
                            <iframe 
                                src={getSetting('contact', 'contact_map_embed', 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3964.150711139771!2d106.73816268477667!3d-6.5025976467700355!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69c3af7cf49cff%3A0x31c36e13b0f3b5f2!2sMAHAD%20IMAM%20HAFSH!5e0!3m2!1sen!2sid!4v1768376416507!5m2!1sen!2sid')} 
                                width="100%" 
                                height="100%" 
                                style={{ border: 0 }} 
                                allowFullScreen 
                        ...
                        <div className="flex flex-col justify-center space-y-6">
                            ...
                            <p className="text-slate-600">
                                {getSetting('contact', 'contact_description', 'Lokasi strategis boarding school sangat strategis dan asri, dengan dikelilingi sawah, bukit, dan view gunung Salak Bogor.')}
                            </p>
