        ...
        <AppLayout>
            <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 p-6">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="mb-8">
                        <h3 className="text-lg font-semibold mb-4 text-slate-900">Akses Sistem Sekolah</h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            <Link href="/admin/payments">
                                <Card className="p-4 hover:shadow-md transition-shadow cursor-pointer border-l-4 border-l-green-500 hover:bg-green-50">
                                    <CardContent className="p-0">
                                        <div className="flex items-center space-x-3">
                                            <CreditCard className="h-8 w-8 text-green-600" />
                                            <div>
                                                <div className="font-semibold">Pembayaran SPP</div>
                                                <div className="text-sm text-muted-foreground">Cek status pembayaran</div>
                                            </div>
                                        </div>
                                    </CardContent>
                                </Card>
                            ...
                            <Link href="/chat">
                                <Card className="p-4 hover:shadow-md transition-shadow cursor-pointer border-l-4 border-l-purple-500 hover:bg-purple-50">
                                    <CardContent className="p-0">
                                        <div className="flex items-center space-x-3">
                                            <MessageSquare className="h-8 w-8 text-purple-600" />
                                            <div>
                                                <div className="font-semibold">Chat Real-time</div>
                                                <div className="text-sm text-muted-foreground">Komunikasi dengan guru</div>
                                            </div>
                                        </div>
                                    </CardContent>
                                </Card>
                            ...
                            <Link href="/teacher/behavior-reports">
                                <Card className="p-4 hover:shadow-md transition-shadow cursor-pointer border-l-4 border-l-orange-500 hover:bg-orange-50">
                                    <CardContent className="p-0">
                                        <div className="flex items-center space-x-3">
                                            <BarChart3 className="h-8 w-8 text-orange-600" />
                                            <div>
                                                <div className="font-semibold">Laporan Perilaku</div>
                                                <div className="text-sm text-muted-foreground">Lihat perkembangan anak</div>
                                            </div>
                                        </div>
                                    </CardContent>
                                </Card>
                            ...
                            <Link href="/teacher/lesson-plans">
                                <Card className="p-4 hover:shadow-md transition-shadow cursor-pointer border-l-4 border-l-blue-500 hover:bg-blue-50">
                                    <CardContent className="p-0">
                                        <div className="flex items-center space-x-3">
                                            <FileText className="h-8 w-8 text-blue-600" />
                                            <div>
                                                <div className="font-semibold">Rencana Pelajaran</div>
                                                <div className="text-sm text-muted-foreground">Jadwal pembelajaran</div>
                                            </div>
                                        </div>
                                    </CardContent>
                                </Card>
