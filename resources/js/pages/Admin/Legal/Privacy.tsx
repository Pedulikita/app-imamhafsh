...
import { update as updateRoute } from '@/routes/admin/legal-content/privacy';
...
export default function Privacy({ content }: Props) {
    ...
    const handleSubmit: FormEventHandler = (e) => {
        ...
        put(updateRoute(), {
            onSuccess: () => {
                setSuccessMessage('Kebijakan Privasi berhasil diperbarui');
                setErrorMessage('');
            ...
            <div className="space-y-6">
                <div>
                    ...
                    <p className="mt-2 text-slate-600">
                        Kelola konten Kebijakan Privasi yang ditampilkan pada website
                    </p>
                </div>
