...
export default function Create() {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { label: 'Tambah Activity', href: '/admin/activities/create' },
    ];
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col gap-4 p-4">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-semibold">Tambah Activity</h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="rounded-xl border border-sidebar-border/70 bg-background p-6 space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                placeholder="Pendidikan, Olahraga, Seni"
                            />
                        </div>
                    </div>
                    ...
                    <div className="flex justify-end gap-3">
                        ...
                        <Button type="submit" disabled={processing}>
                            {processing ? 'Menyimpan...' : 'Simpan Activity'}
                        </Button>
                    </div>
                </form>
            </div>
