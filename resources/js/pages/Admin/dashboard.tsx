        ...
        <AppLayout breadcrumbs={[
            ...
            <div className="min-h-screen ">
                ...
                <div className="mx-auto px-6 sm:px-6 lg:px-8 py-8">
                    {/* New Systems Cards - Prominent Display */}
                    <div className="mb-8">
                        <h2 className="text-xl font-semibold mb-4">Sistem Baru</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {/* Lesson Plans */}
                            <Card className="p-6 bg-gradient-to-br from-blue-500 to-blue-600 text-white border-0 shadow-lg hover:shadow-xl transition-shadow">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-blue-100 text-sm font-medium">Lesson Plans</p>
                                        <p className="text-3xl font-bold">{stats.lesson_plans?.total || 0}</p>
                                    </div>
                                ...
                                <div className="mt-4 flex items-center text-sm">
                                    ...
                                    <span className="text-blue-100">
                                        {stats.lesson_plans?.this_month || 0} bulan ini
                                    </span>
                                </div>
                            </Card>

                            {/* Payment System */}
                            <Card className="p-6 bg-gradient-to-br from-green-500 to-green-600 text-white border-0 shadow-lg hover:shadow-xl transition-shadow">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-green-100 text-sm font-medium">Payments</p>
                                        <p className="text-xl font-bold">Rp {((stats.payments?.total_amount || 0)/1000000).toFixed(1)}M</p>
                                    </div>
                                ...
                                <div className="mt-4 flex items-center text-sm">
                                    ...
                                    <span className="text-green-100">
                                        {stats.payments?.pending_payments || 0} pending
                                    </span>
                                </div>
                            </Card>

                            {/* Real-time Chat */}
                            <Card className="p-6 bg-gradient-to-br from-purple-500 to-purple-600 text-white border-0 shadow-lg hover:shadow-xl transition-shadow">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-purple-100 text-sm font-medium">Real-time Chat</p>
                            ...
                            {/* Behavior Reports */}
                            <Card className="p-6 bg-gradient-to-br from-orange-500 to-orange-600 text-white border-0 shadow-lg hover:shadow-xl transition-shadow">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-orange-100 text-sm font-medium">Behavior Reports</p>
                                        <p className="text-3xl font-bold">{stats.behavior_reports?.total || 0}</p>
                                    </div>
                                ...
                                <div className="mt-4 flex items-center text-sm">
                                    ...
                                    <span className="text-orange-100">
                                        {stats.behavior_reports?.this_week || 0} minggu ini
                                    </span>
                                </div>
                            </Card>
                        </div>
