...
export default function Edit({ teamMember }: Props) {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { label: 'Edit Team Member', href: `/admin/team-members/${teamMember.id}/edit` },
    ];
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        category: teamMember.category || 'Staff',
            ...
            <div className="flex flex-col gap-4 p-4">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                            Update team member: {teamMember.name}
                        </p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="rounded-xl border border-sidebar-border/70 bg-background p-6 space-y-4">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="image">Upload Foto Baru</Label>
                            <Input
                                id="image"
                                type="file"
                                accept="image/*"
                    ...
                    <div className="flex justify-end gap-3">
                        ...
                        <Button type="submit" disabled={processing}>
                            {processing ? 'Menyimpan...' : 'Update Team Member'}
                        </Button>
                    </div>
                </form>
            </div>
