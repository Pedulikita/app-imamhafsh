      ...
      <div className="flex flex-col gap-4 p-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Buat artikel atau berita baru</p>
          </div>
        </div>
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="rounded-xl border border-sidebar-border/70 bg-background p-6 space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">Kosongkan untuk generate otomatis dari judul</p>
              </div>
